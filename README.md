...
For linting and formatting, we follow [Google's markdown style guide](https://google.github.io/styleguide/docguide/style.html) with some divergences. See [crates/tdr-lang/FORMATTING.md](crates/tdr-lang/FORMATTING.md) for details.
