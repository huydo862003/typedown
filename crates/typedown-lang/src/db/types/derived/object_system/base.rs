...
pub trait TdrObjectLike: Id {
  ...
  fn eq(&self, _db: &::typedown_lang::db::TypedownDatabase, other: &TdrObjectEnum) -> bool {
    self.as_id() == other.as_id()
  }

  fn lt(&self, _db: &::typedown_lang::db::TypedownDatabase, other: &TdrObjectEnum) -> bool {
    self.as_id() < other.as_id()
  }

  fn gt(&self, _db: &::typedown_lang::db::TypedownDatabase, other: &TdrObjectEnum) -> bool {
    self.as_id() > other.as_id()
  }

  fn le(&self, _db: &::typedown_lang::db::TypedownDatabase, other: &TdrObjectEnum) -> bool {
    self.as_id() <= other.as_id()
  }

  fn ge(&self, _db: &::typedown_lang::db::TypedownDatabase, other: &TdrObjectEnum) -> bool {
    self.as_id() >= other.as_id()
  }
}

fn get_builtin_field(db: &::typedown_lang::db::TypedownDatabase, name: &str) -> Option<TypeMember> {
  match name {
...
pub trait TdrTypeLike: TdrObjectLike {
  ...
  fn get_supertype(&self, db: &::typedown_lang::db::TypedownDatabase) -> TdrTypeEnum;
  fn get_vtable(
    &self,
...
impl TdrTypeType {
  pub fn get(db: &::typedown_lang::db::TypedownDatabase) -> TdrTypeType {
    get_type_type(db)
  }
}
...
impl TdrObjectType {
  pub fn get(db: &::typedown_lang::db::TypedownDatabase) -> TdrObjectType {
    get_object_type(db)
  }
}
